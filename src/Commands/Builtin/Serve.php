...
{
    public const DEFAULT_BASE_PATH     = '.htrouter.php';
    public const DEFAULT_DOCUMENT_ROOT = 'public';
    public const DEFAULT_HOSTNAME      = '0.0.0.0';
    ...
    public function getHelp(): void
    {
        ...
        print Color::colorize(
            '  serve [hostname=' . self::DEFAULT_HOSTNAME .
            '] [port=' . self::DEFAULT_PORT .
            '] [entrypoint=' . self::DEFAULT_BASE_PATH .
            '] [document-root=' . self::DEFAULT_DOCUMENT_ROOT . ']',
            Color::FG_GREEN
        ) . PHP_EOL . PHP_EOL;
